...
CREATE OR REPLACE  FUNCTION pg_lip_bloom_set_overhead_test(integer) RETURNS integer
     AS '/mnt/pg_lip_bloom/pg_lip_bloom/pg_lip_bloom', 'pg_lip_bloom_set_overhead_test'
     LANGUAGE C STRICT PARALLEL UNSAFE;
...
--      AS '/mnt/pg_lip_bloom/pg_lip_bloom/pg_lip_bloom', 'pg_lip_bloom_probe_order_test_2'
--      LANGUAGE C STRICT PARALLEL SAFE IMMUTABLE 
--      COST 1000;

-- CREATE OR REPLACE FUNCTION pg_lip_bloom_probe_dynamic_2(integer, integer, integer, integer) RETURNS boolean
--      AS '/mnt/pg_lip_bloom/pg_lip_bloom/pg_lip_bloom', 'pg_lip_bloom_probe_dynamic_2'
--      LANGUAGE C STRICT PARALLEL SAFE IMMUTABLE 
--      COST 1000;
...
--      AS '/mnt/pg_lip_bloom/pg_lip_bloom/pg_lip_bloom', 'pg_lip_bloom_probe_order_test_3'
--      LANGUAGE C STRICT PARALLEL SAFE IMMUTABLE 
--      COST 1000;

-- CREATE OR REPLACE FUNCTION pg_lip_bloom_probe_dynamic_3(integer, integer, integer, integer, integer, integer) RETURNS boolean
--      AS '/mnt/pg_lip_bloom/pg_lip_bloom/pg_lip_bloom', 'pg_lip_bloom_probe_dynamic_3'
--      LANGUAGE C STRICT PARALLEL SAFE IMMUTABLE 
--      COST 1000;
------------------------------------------------------------------------------